...
window.Cms = function () {
  ...
  return {
    ...
    initTinymce: function initTinymce() {
      ...
      tinymce.init((_tinymce$init = {
      ...
      }, _defineProperty(_tinymce$init, "convert_urls", false), _defineProperty(_tinymce$init, "allow_unsafe_link_target", true), _defineProperty(_tinymce$init, "images_upload_handler", function images_upload_handler(blobInfo, success, failure) {
        var xhr, formData;
        ...
        formData.append('file', blobInfo.blob(), blobInfo.filename()); // append CSRF token in the form data
...
module.exports = __webpack_require__(/*! /Users/marcoasperti/web/magutti/maguttiCms/resources/js/admin/cms.js */"./resources/js/admin/cms.js");
