    ...
    <div class="col-12">
        <div class="form-group">
            <div class="custom-control custom-checkbox">
                ...
                <x-website.ui.form-error-label class="pt-1" field="billing_shippingAsBilling"></x-website.ui.form-error-label>
            </div>
        </div>
    </div>
</div>
<div  class="row" id="billing_address_box" {!! ($cart->hasBillingAddress())? ' ' : ' style="display:none"' !!}   >
    ...
    <div class="col-12 col-md-6">
        <div class="form-group">
            <input type="text" class="form-control" placeholder="{{ trans('website.lastname') }}" name="billing_lastname"
    ...
    <div class="col-12 col-sm-6 form-group">
        <input class="form-control" type="text" name="billing_province" value="{{ old('billing_province') ?? optional($cart->billing_address)->province  }}"
    ...
    <div class="col-12 col-sm-6 form-group">
        <input class="form-control" type="text" name="billing_phone" value="{{ old('billing_phone') ?? optional($cart->billing_address)->phone }}"
    ...
    <div class="col-12 col-sm-6 form-group">
        <input class="form-control" type="text" name="billing_vat" value="{{ old('billing_vat') ?? optional($cart->billing_address)->vat }}"
